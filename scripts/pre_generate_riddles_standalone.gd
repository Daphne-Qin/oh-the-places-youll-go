...
## Standalone Riddle Pre-Generation Script
## 
## Alternative version that can be run as a regular scene/node
## Useful if EditorScript doesn't work in your Godot version
##
## HOW TO USE:
## 1. Create a new scene with just a Node
...
func _ready() -> void:
	print("==================================================")
	print("RIDDLE PRE-GENERATION TOOL (Standalone)")
	print("==================================================")
