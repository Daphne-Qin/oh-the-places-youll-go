...
func walk_noclover(speed: float = 20.0) -> void:
	"""Play the walk animation (used on ready and for patrol)."""
	sprite.sprite_frames.set_animation_speed("walk_noclover", speed)
	sprite.play("walk_noclover")

func walk_clover(speed: float = 20.0) -> void:
	"""Play the walk animation (used on ready and for patrol)."""
	sprite.sprite_frames.set_animation_speed("walk_clover", speed)
	sprite.play("walk_clover")
